...
NC="\e[0m"
RED="\033[0;31m" 
COLOR1="$(cat /etc/aixxy7/theme/$colornow | grep -w "TEXT" | cut -d: -f2|sed 's/ //g')"
COLBG1="$(cat /etc/aixxy7/theme/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')"                    
###########- END COLOR CODE -##########
...
function addvmess(){
clear
source /var/lib/aixxy7-pro/ipvps.conf
...
echo -e "$COLOR1 ${NC} Path WSS      : wss://bug.com/worryfree" 
